...
<div class="container mx-auto px-6 py-12">
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <a href="{{ route('categories.index') }}" class="mr-4 bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Cancel</a>
